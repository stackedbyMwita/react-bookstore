                ...
                <div className="container max-w-screen-lg mx-auto">
                    <div>
                        <div>
                            ...
                            <div className="text-gray-500 mb-2 flex gap-2">Total Price: <p className='font-bold text-blue-950'>${totalPrice}</p></div>
                            <p className="text-gray-500 mb-6 font-bold">Items: {cartItems.length > 0 ? cartItems.length : 0}</p>
                        </div>
                            ...
                            <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                                    <div className="text-gray-600">
                                        <p className="font-bold mb-4 text-2xl">Personal Details</p>
                                        ...
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-5 text-right">
                                                <div className="inline-flex items-end">
                                                    <button
                                                        disabled={!isChecked}
                                                        className="bg-blue-950 hover:bg-yellow-400 hover:text-blue-950 text-white font-bold py-2 px-4 rounded">Place an Order</button>
                                                </div>
                                            </div>
